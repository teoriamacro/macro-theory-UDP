...
```{r}
datosbc=read.table("C:/Users/Stefano/Desktop/Datos banco central/Cuadrobc.csv",header=F,sep=";",quote="")
datosbc=datosbc[ ,1:2]
...
```{r}
datostpm2=read.csv("C:/Users/Stefano/Desktop/Datos banco central/CuadroTPM.csv",header=F,sep=";",quote="")
...
```{r}
mitabla2 = tabular( (tpm + 1)*(mean+sd), data= na.omit(datostpm))
```
