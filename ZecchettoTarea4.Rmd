...
```
 ...
 Después convertimos las frecuencias a probabilidades dividiendo cada frecuencia por la suma y usando el comando plot para graficar la distribución predictiva.
